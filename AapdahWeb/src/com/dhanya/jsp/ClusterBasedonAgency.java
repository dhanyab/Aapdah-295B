...
//	String datafile5 = abspath + "/data/Sunnyvale.csv";
	...
	String[] row = null;
			...
			FileWriter writerPa = new FileWriter(abspath
					+ "datafiles/paloalto.csv");
			...
			FileWriter writerSM = new FileWriter(abspath
					+ "datafiles/sanmateo.csv");
			FileWriter writerSu = new FileWriter(abspath
					+ "datafiles/sunnyvale.csv");
			FileWriter writerSF = new FileWriter(abspath
					+ "datafiles/sfo.csv");
